...
% is not here. Nine claims were withdrawn during this project, every one
...
% xurl lets long URLs (the code URL in the text) break across lines rather than
% overrun the column.
\usepackage{xurl}
...
% src: 59,280 = 12,722 real + 46,558 generated (ledger I2, O4). CORRECTED
%      2026-09-23: read "6,361", the held-out half, beside FMC's full 5,355.
$12{,}722$ reals;
...
% src: gate_h4_fmc n = 32,960 + gate_h4_sonics n = 59,280 (ledger R27.45, O4).
%      CORRECTED 2026-09-23: read "32,960", which is FakeMusicCaps alone.
both corpora and $92{,}240$ tracks, and bandwidth-matched twins bound the residual
...
$M{=}4$ this leaves $441$ admissible lags on FakeMusicCaps and $252$ on SONICS.
% src: comb_prior_harmonic_null(n_harm=4) at bin 24000/16384 returns n_lags 252
%      (ledger R27.43). CORRECTED 2026-09-23 from 253, a docstring slip.
